...
<html>
    ...
    <body>
    <div class="banner" style="background-color: rgb(157 204 55); width:15000px; height:125px;">
    	<img class="logo" src="<?=base_url()?>assets/img/logo.png" style="margin-top:15px;" width="100" height="100">
